...
PROFILES = [
    "Motivated energy systems student specializing in renewable energy integration, microgrid design, and environmental sustainability. Possesses a rigorous technical foundation in data modeling, project coordination, and scientific research methodologies gained through hands-on capstone engineering. Experienced in leveraging simulation software including PVSyst, QGIS spatial mapping, and Python analytics to solve complex clean energy challenges. Eager to secure a challenging internship opportunity to apply academic knowledge and drive tangible decarbonization impact within utility-scale renewable energy developments.",
    "Dedicated energy systems learner committed to accelerating the global transition toward zero-carbon power and resilient smart infrastructure. Demonstrates advanced coursework proficiency in high-voltage grid integration, SCADA telemetry monitoring, and battery energy storage solutions (BESS). Proven collaborator with hands-on experience in multidisciplinary engineering teamwork, technical report writing, and community stakeholder engagement. Eager to contribute analytical rigor and field survey expertise to leading clean energy developers and utility projects.",
    "Results-oriented sustainability scholar with a deep academic specialization in clean technology, energy auditing, and building efficiency optimization. Proficient in carbon baseline accounting, life cycle assessment (LCA) frameworks, and regional environmental regulatory compliance. Combines strong quantitative data analysis with effective technical communication skills developed through student leadership and industry workshops. Seeking a fast-paced placement opportunity to support feasibility studies, environmental permitting, and renewable project execution.",
    "Environmentally conscious engineering student equipped with strong analytical, technical, and spatial problem-solving capabilities. Background encompasses comprehensive study in climate science, smart grid stability, environmental impact assessment (EIA), and energy economics. Skilled in conducting field survey audits, synthesizing complex meteorological data, and compiling executive technical briefings. Aspiring to launch a professional career in sustainable infrastructure development by delivering value from day one.",
    "Proactive engineering student passionate about driving technological innovation within solar PV sizing, inverter electronics, and commercial energy storage. Competent in utilizing RETScreen, AutoCAD, and Power BI dashboards to evaluate project yield metrics and economic payback periods. Recognized for strong self-motivation, attention to technical detail, and active participation in clean tech student associations. Seeking an internship placement to contribute to commercial solar-as-a-service implementations and microgrid commissioning.",
    "Analytical energy studies researcher with a focused specialization in wind energy resource assessment, atmospheric anemometer data processing, and wake loss modeling. Possesses practical experience in spatial GIS mapping, environmental baseline monitoring, and fluid mechanics principles. Demonstrated ability to collaborate across engineering teams, present empirical research at student symposiums, and manage technical task milestones. Looking to leverage technical modeling skills in utility-scale wind farm development."
]
...
def generate_content(name, email, country, lang="en"):
    ...
    # Clean role titles for smooth narrative flow without "Intern - " grammar glitches
    def clean_role_text(poste):
        return poste.replace("Intern - ", "").replace("Intern — ", "").replace("Intern ", "").strip()

    p1_clean = clean_role_text(c1['poste_en'])
    p2_clean = clean_role_text(c2['poste_en'])
    ...
    summaries = [
        # Style 1: Goal-first
        lambda: f"My goal is simple: to contribute meaningfully to the renewable energy transition. After completing my studies at {uni}, I began researching opportunities where I could put my knowledge into practice. Two positions stood out. {c1['name']} is hiring for a {p1_clean} role in {city}. {c1['desc_en']} What excites me most is the chance to work on {s1[0].lower()}. I also found an opportunity at {c2['name']} as a {p2_clean}. {c2['desc_en']} Both roles would push me to grow in areas like {clean_join([s2[1], s1[2]])}. I am ready for this step.",
        # Style 2: Problem-focused
        lambda: f"Climate change demands urgent action, and the renewable energy sector is where solutions are being built every day. That conviction grew stronger during my time at {uni}, where I studied energy systems and sustainability. Now, I want to move from theory to practice. I discovered that {c1['name']} offers a {p1_clean} position in {city}. {c1['desc_en']} Separately, {c2['name']} has an opening for a {p2_clean}. {c2['desc_en']} Either role would give me real experience in {clean_join([s1[0], s2[0]])}, skills that are critical for this sector. I am committed to being part of the solution.",
        # Style 3: Story-driven
        lambda: f"It started with a question: how can one person make a difference in the fight against climate change? That question led me to {uni}, where I explored renewable energy, environmental science, and sustainable development. It led me to the Green Pathways program, which sharpened my professional skills. And now it leads me to two specific opportunities. The first is at {c1['name']}, a {p1_clean} role based in {city}. {c1['desc_en']} The second is at {c2['name']}, offering a {p2_clean} position. {c2['desc_en']} I have the skills — {clean_join([s1[0], s2[1]])}, as well as analytical thinking — and the motivation. What I need now is the opportunity to prove it.",
        # Style 4: Skills-focused
        lambda: f"Throughout my education at {uni}, I developed a diverse skill set that I believe makes me a strong candidate for opportunities in renewable energy. My abilities include {clean_join([s1[0], s1[1], s2[0]])}. I am now looking to apply these competencies in a professional setting. Two opportunities align well with my profile. {c1['name']} is seeking a {p1_clean} in {city}, focusing on {c1['desc_en'].split('.')[0].lower()}. Meanwhile, {c2['name']} has a {p2_clean} role that involves {c2['desc_en'].split('.')[0].lower()}. Both positions offer the kind of hands-on experience that would accelerate my professional growth and deepen my commitment to the energy transition.",
        # Style 5: Conversational
        lambda: f"If someone asked me where I see myself in five years, my answer would be clear: working in renewable energy, helping communities access clean power. That vision took shape at {uni} and became sharper through the Green Pathways program. Right now, I am looking at two paths forward. One leads to {c1['name']}, where I could work as a {p1_clean} in {city}. {c1['desc_en']} The other leads to {c2['name']} and their {p2_clean} position. {c2['desc_en']} Both would help me build practical experience in {clean_join([s1[0], s2[1]])}. I am excited about either direction.",
        # Style 6: Analytical
        lambda: f"After careful analysis of the renewable energy job market in my region, I identified two positions that match both my qualifications and career objectives. Position one: {p1_clean} at {c1['name']}, located in {city}. {c1['desc_en']} Key requirements include {clean_join([s1[0], s1[1]])}, which I developed at {uni}. Position two: {p2_clean} at {c2['name']}, also in {city}. {c2['desc_en']} This role emphasizes {clean_join([s2[0], s2[1]])}. My academic preparation, including coursework in sustainability and environmental analysis, positions me well for either role. I am confident in my ability to deliver value from day one.",
        # Style 7: Passion-led
        lambda: f"Renewable energy is not just a career choice for me — it is a calling. Every course I took at {uni}, every project I completed, reinforced my desire to work in this field. The Green Pathways program gave me the professional tools to turn that passion into action. I have identified two roles that would allow me to do exactly that. At {c1['name']}, the {p1_clean} role in {city} offers a chance to work on real projects. {c1['desc_en']} At {c2['name']}, the {p2_clean} position provides a different but equally valuable perspective. {c2['desc_en']} I bring strong skills in {clean_join([s1[0], s2[0]])}, and an unwavering commitment to sustainability.",
        # Style 8: Future-oriented
        lambda: f"The energy landscape is changing rapidly, and professionals who can bridge technical knowledge with practical application will be in high demand. My studies at {uni} have prepared me for this reality. I understand both the science behind renewable energy and the project management skills needed to implement it. Looking ahead, I see two clear opportunities to begin my career. {c1['name']} is offering a {p1_clean} position in {city}. {c1['desc_en']} Additionally, {c2['name']} has a {p2_clean} role available. {c2['desc_en']} With expertise in {s1[0].lower()} and a growing knowledge of {s2[1].lower()}, I am well-positioned to contribute immediately.",
        # Style 9: Compact and direct
        lambda: f"I am seeking an opportunity in renewable energy. My background: {uni}, with skills in {clean_join([s1[0], s1[1], s2[0]])}. Two opportunities interest me. First: {p1_clean} at {c1['name']} in {city}. {c1['desc_en']} I would bring my {s1[0].lower()} expertise to this role. Second: {p2_clean} at {c2['name']}. {c2['desc_en']} My {s2[0].lower()} skills make me a strong fit. Through the Green Pathways program, I have refined my professional competencies and am ready to start contributing to the energy transition.",
        # Style 10: Reflective
        lambda: f"Looking back at my time at {uni}, I realize that every module, every group project, and every late-night study session was building toward one thing: a career in renewable energy. The Green Pathways program confirmed this direction and helped me articulate my goals more clearly. I have now identified two opportunities that feel right. {c1['name']} is looking for a {p1_clean} in {city}. {c1['desc_en']} I find this appealing because of the focus on {s1[0].lower()}. There is also an opening at {c2['name']} for a {p2_clean}. {c2['desc_en']} What draws me to this role is the emphasis on {clean_join([s2[0], s2[1]])}. I feel ready to take this next step.",
        # Style 11: Academic Track Focus
        lambda: f"My academic trajectory at {uni} centered on {track['name'].lower()}. Through my capstone research on '{track['projects'][0]}', I developed practical data modeling and technical analysis capabilities. To transition these skills into industry, I am targeting two placements. First, {c1['name']} as a {p1_clean} in {city}, where I can contribute to {s1[0].lower()}. Second, {c2['name']} as a {p2_clean}, focusing on {s2[0].lower()}. Both opportunities represent ideal launchpads for my career.",
        # Style 12: Field Work & Methodologies
        lambda: f"Field investigation and empirical research at {uni} formed the foundation of my clean energy training. Working on {track['projects'][0].lower()} sharpened my abilities in {clean_join([s1[0], s2[0]])}. I am now eager to apply these methodologies to industry projects. Position 1 at {c1['name']} offers a {p1_clean} opening in {city}, which matches my technical background in {s1[1].lower()}. Position 2 at {c2['name']} provides a {p2_clean} opportunity. I am motivated to deliver immediate technical value.",
        # Style 13: Decarbonization Vision
        lambda: f"Accelerating regional decarbonization requires rigorous technical engineering and strategic project execution. My coursework at {uni} provided a deep understanding of renewable energy systems, which I expanded during my capstone study on {track['projects'][0].lower()}. As I look to enter the clean tech workforce, {c1['name']} ({p1_clean} in {city}) and {c2['name']} ({p2_clean}) stand out as premier organizations where I can apply my skills in {clean_join([s1[0], s2[1]])}.",
        # Style 14: Strategic Placement Alignment
        lambda: f"The Green Pathways initiative provided the bridge between my academic studies at {uni} and professional career deployment. Through coursework in {track['coursework'].split(',')[0].lower()} and capstone modeling, I gained strong technical competencies. I am now targeting internship roles at {c1['name']} ({p1_clean}) and {c2['name']} ({p2_clean}). Both companies are leading key energy projects in {city}, and I am prepared to contribute effectively.",
        # Style 15: Engineering Systems Perspective
        lambda: f"Engineering scalable renewable solutions requires a holistic understanding of resource analytics, energy yield modeling, and environmental compliance. My preparation at {uni} focused on these core domains. Two career opportunities align directly with my technical capabilities: a {p1_clean} role at {c1['name']} in {city}, and a {p2_clean} position at {c2['name']}. With expertise in {s1[0].lower()} and {s2[0].lower()}, I am excited to begin my professional journey.",
    ]
